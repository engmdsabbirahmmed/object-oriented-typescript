{
    ...
    class Person {
        ...
        education: string;
        address: string;
        constructor(name: string, age: number, education: string, address: string) {
            this.name = name;
            this.age = age;
    ...
    class Teacher extends Person {
        designation: string
        constructor(name: string, age: number, education: string, address: string, designation: string) {
            super(name, age, education, address);
            this.designation = designation;
        }
